...
function App({ user }: ProductProps) {
    ...
    }, [paging.pageNumber, searchCondition.searchDateType, searchCondition.category, searchCondition.searchMode, searchCondition.searchKeyword]);
                ...
                <Button
                    ...
                    onClick={async (event) => {
                        ...
                        try { // 상품을 삭제 후 다시 상품 목록 페이지를 보여 줍니다. 
                            ...
                            await customAxios.delete(`${API_BASE_URL}/product/delete/${item.id}`);
